...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/nihr_search_awards \
  -H 'Content-Type: application/json' \
  -d '{"query":"dementia","project_status":"Active","min_amount":1000000,"limit":10}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/nihr_search_awards`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
